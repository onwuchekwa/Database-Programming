...
-- Open log file.
SPOOL apply_plsql_lab8_procedure.txt
...
-- ======================================================
  ...
  */
  ...
  -- Get the number of records with the user name
  SELECT 
    COUNT(1)
  INTO   lv_count
  FROM   system_user
  ...
  -- SET the value of the lv_created_by is the record count is 0
  IF lv_count = 0 THEN
    lv_created_by := -1; 
  END IF;
...
-- ==================================================================
-- The insert_contact procedure requires a formal parameter list. 
-- The procedure should include all the values that you need to 
...
-- ==================================================================
-- After you call the overloaded insert_contact procedures three 
